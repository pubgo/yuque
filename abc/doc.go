...
var GetDocsByName = _url("/repos/%s/docs")

// 创建文档
var CreateDoc = _url("/repos/%s/docs")
var CreateDocByName = _url("/repos/%s/docs")

// 获取单篇文档的详细信息
var GetDoc = _url("/repos/%s/docs/%s")
var GetDocByName = _url("/repos/%s/docs/%s")

// 更新文档
var UpdateDoc = _url("/repos/%s/docs/%s")
var UpdateDocByName = _url("/repos/%s/docs/%s")

// 删除文档
var DelDoc = _url("/repos/%s/docs/%s")
var DelDocByName = _url("/repos/%s/docs/%s")
